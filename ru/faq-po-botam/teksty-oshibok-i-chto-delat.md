...
Возникает, когда минимальный размер ордера на бирже был обновлен и теперь больше, чем ордер бота. Стоит попробовать изменить настройки бота так, чтобы увеличить размер 1-ого ордера сетки.

Это можно сделать с помощью:

* увеличения депозита бота,
* сокращения числа ордеров сети,
* уменьшения значения **Factor**.
